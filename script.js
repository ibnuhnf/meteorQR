let imgBox = document.getElementById("imgBox"); // Pastikan ID ini sesuai
...
// Menambahkan event listener untuk mouse enter dan leave pada imgBox
imgBox.addEventListener('mouseenter', () => {
    document.body.style.pointerEvents = 'none'; // Menonaktifkan interaksi dengan latar belakang
});

imgBox.addEventListener('mouseleave', () => {
    document.body.style.pointerEvents = 'auto'; // Mengaktifkan kembali interaksi
});
